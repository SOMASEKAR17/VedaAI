    ...
    <div className="flex flex-col gap-2 w-full select-none">
      ...
      <div className="relative w-full">
        <input
          ...
          className={`w-full bg-[#fcfcfc] text-[#1c1c1c] border rounded-[16px] px-4 py-3.5 pr-12 text-sm focus:outline-none focus:ring-1 transition-all duration-200 placeholder:text-[#a0a0a0] font-sans font-medium ${
            errors.dueDate
