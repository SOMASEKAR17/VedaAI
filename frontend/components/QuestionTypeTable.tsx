        ...
        <div className="flex flex-col gap-4">
          {questionTypes.map((row) => {
            ...
            return (
              <div
                key={row.id}
                className="flex flex-col gap-2 w-full border-b border-[#fbfbfb] pb-3"
              >
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full bg-transparent">
                  ...
                  <div className="flex w-full sm:w-1/2 md:w-2/5 justify-between items-center sm:pl-8 sm:pr-4 gap-4">
                    <div
                      className={`flex items-center justify-between border rounded-full p-1.5 w-[110px] shrink-0 shadow-sm transition-all duration-200 ${
                        countError
                    ...
                    <div
                      className={`flex items-center justify-between border rounded-full p-1.5 w-[100px] shrink-0 shadow-sm transition-all duration-200 ${
                        marksError
                          ? "bg-[#fdf5f2] border-[#e15222]"
                          : "bg-[#f5f5f5] border-[#ebebeb]"
                      }`}
                ...
                {(countError || marksError) && (
                  <div className="flex flex-col gap-0.5 sm:pl-4 w-full text-left shrink-0">
                    {countError && (
