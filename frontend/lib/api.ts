export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || "https://vedaai.duckdns.org/api";
export const WS_BASE_URL = process.env.NEXT_PUBLIC_WS_URL || "ws://vedaai.duckdns.org";
