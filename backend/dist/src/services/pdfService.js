...
function buildHTML(result, assignment, withAnswerKey = false) {
...
async function generatePDF(result, assignment, withAnswerKey = false, suffix = '') {
    ensurePdfDir();
    const filePath = path_1.default.join(PDF_DIR, `assignment-${result.assignmentId}${withAnswerKey ? '-key' : ''}${suffix}.pdf`);
